    ...
    <div class="container">
     <!--  breadcrumb --> 
      ...
      <div class="row">        
        <!-- Register Account-->
        <div class="span9">
          <h1 class="heading1"><span class="maintext">注册账户</span><span class="subtext">账户信息注册</span></h1>
          <form class="form-horizontal" action="" method="post">
            ...
            <div class="registerbox">
              <fieldset>
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="realName"   class="input-xlarge" required="required">
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="email" name="email"  class="input-xlarge" required="required">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label"><span class="red">*</span> 电话:</label>
                  <div class="controls">
            ...
            <div class="registerbox">
              <fieldset>
                ...
                <div class="control-group">
                  <label class="control-label"><span class="red">*</span> 地址 1:</label>
                  <div class="controls">
                    <input type="text"  class="input-xlarge">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label"> 地址 2:</label>
                  <div class="controls">
                    <input type="text"  class="input-xlarge">
                  </div>
                </div>
                ...
                <div class="control-group">
                  <label class="control-label">
                    <span class="red">*</span>地区 / 州:</label>
                  <div class="controls">
           ...
           <h3 class="heading3">密码</h3>
            ...
            <!-- <h3 class="heading3">简讯</h3>
           <div class="registerbox">
             <fieldset>
               <div class="control-group">
                 <label class="control-label">订购:</label>
                 <div class="controls">
