                ...
                <div class="tpl-portlet">
                    ...
                    <div class="tpl-scrollable">
                        ...
                        <table class="am-table tpl-table">
                            ...
                            <tr>
                                <td>
                                    <img src="${path}/assets/img/user01.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${path}/assets/img/user02.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${path}/assets/img/user03.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${path}/assets/img/user04.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${path}/assets/img/user05.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${path}/assets/img/user06.png" alt="" class="user-pic">
...
<script src="${path}/assets/js/iscroll.js"></script>
