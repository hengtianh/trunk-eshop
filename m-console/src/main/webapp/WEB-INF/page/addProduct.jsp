...
<body data-type="generalComponents">
                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form id="addProductForm" class="am-form tpl-form-line-form" action="${path}/product/saveProduct.do" method="post" enctype="multipart/form-data">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">名称 <span class="tpl-form-line-small-title">Name</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="pName" class="tpl-form-input" id="user-name" placeholder="请输入产品名称" required>
                                        <small>请填写产品名称。</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="pPrice" placeholder="输入产品单价" required>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="number" name="num" placeholder="输入产品库存数量" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                                <img id="pImgSrc" src="${path}/assets/img/a5.png" alt="">
                                            </div>
                                            <button type="button" class="am-btn am-btn-danger am-btn-sm">
    <i class="am-icon-cloud-upload"></i> 添加封面图片</button>
                                            <input type="file" name="pImgFile" onchange="uploadImg();" required="required" multiple>
                                            <input id="pImg" type="hidden" name="pImg">
                                        </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea name="pDesc" class="" rows="10" id="user-intro" placeholder="请输入描述内容"></textarea>
                                    </div>
                                </div>
    ...
    <script>
        function uploadImg() {
            var options;
            var img = $('#pImgSrc').attr("image");
            alert(img)
            if (img!="" && img != undefined) {
                options = {
                    url:"${path}/product/deleteUploadedImg.do",
                    data:{src:img},
                    dataType:"text",
                    success:function () {
            ...
            options = {
                ...
                success:function (responseText) {
                    ...
                    $('#pImgSrc').attr("image",jsonObj.realPath);
